...
namespace ITIDB.Migrations
{
    ...
    [Migration("20260318110904_fix_instCourseRelation")]
    partial class fix_instCourseRelation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ITIDB.Models.Ins_Course", b =>
                {
                    ...
                    b.HasOne("ITIDB.Models.Instructor", "Instructor")
                        .WithMany("Ins_Courses")
